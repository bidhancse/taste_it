                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr id="tr{{ $DataShow->id }}">
                                        <td>{{$DataShow->food_name}}</td>
                                        <td>
                                            @if($DataShow->food_category == 1)
                                            BREAKFAST
                                            @elseif($DataShow->food_category == 2)
                                            LUNCH
                                            @elseif($DataShow->food_category == 3)
                                            DINNER
                                            @elseif($DataShow->food_category == 4)
                                            DESSERTS
                                            @elseif($DataShow->food_category == 5)
                                            COFFEE & SHAKE
                                            @elseif($DataShow->food_category == 6)
                                            DRINKS
                                            @endif
                                        </td>
                                        <td>{{$DataShow->food_details}}</td>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title">Update Menu Information</h3>
